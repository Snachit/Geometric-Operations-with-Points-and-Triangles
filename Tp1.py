...
trois_points = TroisPoints(pointA, pointB, pointC)

print(f"Distance entre point A et point B: {TroisPoints.distance_entre_points(pointA, pointB)}")
print(f"Milieu entre point A et point B: {TroisPoints.milieu_entre_points(pointA, pointB)}")
